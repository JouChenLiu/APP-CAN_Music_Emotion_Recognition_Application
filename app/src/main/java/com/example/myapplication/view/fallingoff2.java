...
public class fallingoff2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fallingoff2);
        ...
        back_bt.setOnClickListener(new View.OnClickListener() { //點擊後執行返回上一頁的指令
            ...
            public void onClick(View view) {
                ...
                intent.setClass(fallingoff2.this, usermood_third.class);
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent();
                intent.setClass(fallingoff2.this, music_profile.class);
                startActivity(intent);
            }
        });
        t.start();
        ...
        Intent intent = new Intent(fallingoff2.this, grade_music.class);
        ...
        TimerTask task = new TimerTask() {
            @Override
            public void run() {
                NotificationCompat.Builder builder = new NotificationCompat.Builder(fallingoff2.this,"簽收單");
                ...
                NotificationManagerCompat managerCompat =  NotificationManagerCompat.from(fallingoff2.this);
