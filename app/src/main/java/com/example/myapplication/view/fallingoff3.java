...
import com.example.myapplication.grade;
...
public class fallingoff3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fallingoff3);
        ...
        back_bt.setOnClickListener(new View.OnClickListener() { //點擊後執行返回上一頁的指令
            ...
            public void onClick(View view) {
                ...
                intent.setClass(fallingoff3.this, usermood_third.class);
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent();
                intent.setClass(fallingoff3.this, music_profile.class);
                startActivity(intent);
            }
        });
        t.start();
        ...
        Intent intent = new Intent(fallingoff3.this, grade_music.class);
        ...
        TimerTask task = new TimerTask() {
            @Override
            public void run() {
                NotificationCompat.Builder builder = new NotificationCompat.Builder(fallingoff3.this,"簽收單");
                ...
                NotificationManagerCompat  managerCompat =  NotificationManagerCompat.from(fallingoff3.this);
